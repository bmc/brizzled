...
page.date: 2008-08-07 00:11:31
---
I originally hosted this blog on Google's App Engine (GAE). Writing a
small, but functional, blog engine is a useful exercise in learning a web
framework. I wrote blog software to learn more about Django, and I ported
it to App Engine to learn more about App Engine.
...
I originally hosted this blog on [Google App Engine][GAE] (GAE).
Writing a small, but functional, blog engine is a useful exercise
