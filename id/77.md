{{
page.templates: article=html
page.title: Writing Blogging Software for Google App Engine
page.tags: App Engine, blogging, programming, python
page.date: 2008-08007 00:11:31
---
As noted previously, I recently rehosted this blog on Google's App Engine
(GAE). Writing a small, but functional, blog engine is a useful exercise in
learning a web framework. I wrote blog software to learn more about Django,
and I ported it to App Engine to learn more about App Engine.
...
more about Django_, and I ported it to App Engine to learn more about App
Engine.
...
* Comments. It's easy enough to drop Disqus_ into your templates, if you want.
* Integration into blog aggregators like Technorati_. (There's a follow-up
...
* reStructuredText_ markup (instead of HTML) for the articles.
...
First, of course, you have to register with GAE_ and download the
...
into details about how to create your application on the GAE_ site.
...
* The administrative screens (for creating and editing blog articles) live
...
*Now* we're ready to look at the administration view code. First, we have
some imports:
...
The [full-size main page image is here][].
...
to use the reStructuredText_ (RST) markup language. Of course, this means
...
To support RST, the first thing we have to do is make the Docutils_ package
available to our running code. The easiest way to do that is to visit the
Docutils_ web site, download the source code, unpack it, and move the
`docutils` subdirectory (and all its contents) into our blog directory.
...
<img src="77/main-small.png" height="390" width="479">
...
* Support for Pygments_ syntax coloring.
